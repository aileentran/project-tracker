...
3	Data Scraping	Using beautiful soup to get clean data from websites	100
4	Intertools	Use itertators to iterate iterables	70
5	Google Maps API	Using python to gather information from the API	75
\.
